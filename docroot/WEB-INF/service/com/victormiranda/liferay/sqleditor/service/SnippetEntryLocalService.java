...
/**
 * Provides the local service interface for SnippetEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SnippetEntryLocalServiceUtil
...
public interface SnippetEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SnippetEntryLocalServiceUtil} to access the snippet entry local service. Add custom service methods to {@link com.victormiranda.liferay.sqleditor.service.impl.SnippetEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
